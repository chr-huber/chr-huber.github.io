...
. . .
  ...
  - Füllbrunn, Huber, Eckel, et al. (JFQA): Heterogeneity of Beliefs and Trading Behavior: A Reexamination
    - reexamination of previous results with 255 instead of 6 experimental markets
...
## Previous reproducibility estimates of in Economics
...
- Identify main reasons for non-reproducibility:
  - no access to the data set (88%, proprietary / NDA / privacy / subscription).
...
- address external validity concerns
  - e.g., by conducting artefactual and framed field experiments <br>(e.g., experiments with financial professionals)

. . .

- novel questions originating from recent developments in the field 
  - e.g, cryptocurrency markets; how the COVID-19 crash affected decision making; deception and social norms; attention and motivated information acquisition; competitiveness and speculation; ... 
